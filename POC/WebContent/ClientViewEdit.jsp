					...
					<div class="span12">
						...
						<div class="box gradient">
							...
							<div class="title">
								...
								<h4 class="clearfix">
									<span class="left">Client View/Edit</span> <a
										href="<s:url action='listClient' />" class="right box-form">
										<button class="btn btn-info">
											<span class="icon16  typ-icon-back white"></span> Back
										</button>
									</a>
								</h4>
							</div>
							...
							<div class="content noPad clearfix">
								...
								<s:form action="saveClient">
									<s:textfield name="client.clientId" label="Client Id"
										required="true" />
									<s:textfield name="client.clientName" label="Client Name"
										required="true" />
									<s:textfield name="client.address" label="Client Address"
										required="true" />
									<s:hidden name="client.version" />
