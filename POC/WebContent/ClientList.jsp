                	...
                	<div class="span12">
                            ...
                            <div class="box gradient">
                                ...
                                <div class="title">
                                    ...
                                    <h4 class="clearfix"><span class="left">Client List</span>
                                    <a href="<s:url action='viewClient' />" class="right box-form">
                                    	<button class="btn btn-info" ><span class="icon15 icomoon-icon-plus-2 white"></span> ADD</button>
                                	</a>
                                    </h4>
                                </div>
                                <div class="content noPad clearfix">
                                	<display:table name="clientList" requestURI="/listClient.action"  export="true"  
										pagesize="10" decorator="com.viajeros.utils.CommonTableDecorator" class="responsive dynamicTable display table table-bordered"> 
											...
											<display:column property ="clientName" title="Name" sortable="true"/>
