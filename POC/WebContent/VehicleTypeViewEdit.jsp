					...
					<div class="span12">
						...
						<div class="box gradient">
							...
							<div class="title">
								...
								<h4 class="clearfix">
									<span class="left">Vehicle Type View/Edit</span> <a
										href="<s:url action='listVehicleType' />"
							...
							<div class="content noPad clearfix">
								...
								<s:form action="saveVehicleType">
									<s:textfield name="VehicleType.vehicleTypeId" label="Vehicle Type Id" />
									<s:textfield name="VehicleType.name" label="Name" />
